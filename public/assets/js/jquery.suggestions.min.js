! function(e, t) {
    ...
    k.NAME = {
        ...
        formatResult: function(e, t, s, o) {
            ...
            return a.isMobile && ((o || (o = {})).maxLength = 50), e = i.call(a, e, y.getDeepValue(s.data, "name.latin"), t, s, o), e = a.wrapFormattedValue(e, s), d && (d = d.replace(/^(\d{6}?\s+|Россия,\s+)/i, ""), d = a.isMobile ? d.replace(new RegExp("^([^" + g + "]+[" + g + "]+[^" + g + "]+).*"), "$1") : a.highlightMatches(d, t, s, {
                unformattableTokens: _
            })), (c || d || l) && (e += '<div class="' + a.classes.subtext + '"><span class="' + a.classes.subtext_inline + '">' + (c || "") + "</span>" + (n(d, l) || "") + "</div>"), e
        },
    ...
    "GET" != y.getDefaultType() && (e.extend(x, {
        geoLocation: B
    }), e.extend(s, {
        resetLocation: a
        ...
        q = {
            ...
            suggest: function() {
                ...
                if (i.requestMode.userSelect) {
                    ...
                    t = s.formatResult || i.type.formatResult || i.formatResult, n = [], !i.isMobile && s.hint && i.suggestions.length && n.push('<div class="' + i.classes.hint + '">' + s.hint + "</div>"), i.selectedIndex = -1, e.each(i.suggestions, function(e, s) {
                            ...
                            s == i.selection && (i.selectedIndex = e), n.push('<div class="' + i.classes.suggestion + '" data-index="' + e + '">'), n.push(t.call(i, s.value, i.currentValue, s, {
                                unformattableTokens: i.type.unformattableTokens
                            })), o && n.push('<span class="' + i.classes.subtext_label + '">' + y.escapeHtml(o) + "</span>"), n.push("</div>")
            ...
            makeSuggestionLabel: function(t, n) {
                ...
                if (a && c(t, n) && n.data && (e.each(a, function(e) {
                    ...
                    for (;
                        (i = u.exec(y.formatToken(n.value))) && (s = i[1]);) e.each(r, function(e, t) {

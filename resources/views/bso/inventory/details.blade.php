    ...
    <div class="block-inner">
        <div class="pull-right">
            <div class="filter-group">
                {{Form::select('pageCount', collect([3 => '3',  25=>'25', 50=>'50', 100=>'100', 150=>'150']), request()->has('page')?request()->session()->get('page'):25, ['class' => 'form-control select2-all', 'id'=>'pageCount', 'onchange'=>'loadItems();'])}}
            </div>
        </div>
    </div>

        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="filter-group">
                ...
                <div class="btn-group col-xs-12 col-sm-12 col-md-3 col-lg-3">
                    ...
                    {{ Form::select('event_id', collect([1=>'Создать акт', 2=>'Добавить в акт']), 0, ['class' => 'form-control', 'id'=>'event_id', 'onchange'=>'get_realized_acts(3)']) }}
                </div>
...
<script>
    ...
    function loadContent(){
        ...
        $.post("{{url("/bso_acts/acts_implemented/сlean/list/")}}", {data:data}, function (response) {
            loaderHide();
    ...
    function create_act() {
        ...
        $.post("{{url("/bso_acts/acts_implemented/сlean/create_get_realized_acts/")}}", {data:data}, function (response) {
            loaderHide();
            show_actions();
            loadContent();

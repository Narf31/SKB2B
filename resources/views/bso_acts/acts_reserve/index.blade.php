                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="filter-group">
                        <div class="btn-group col-xs-12 col-sm-12 col-md-3 col-lg-3">
                            ...
                            {{ Form::select('bso_cart_type', \App\Models\BSO\BsoCartType::where('published', 1)->orderBy('ordering', "asc")->get()->pluck('title', 'id')->prepend('Не выбрано', -1), -1, ['class' => 'form-control select2-ws', 'id'=>'bso_cart_type', 'onchange'=>'loadItems()']) }}
                        </div>

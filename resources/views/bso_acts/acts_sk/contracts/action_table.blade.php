...
<table class="table table-bordered">
    ...
    <tbody>
        <tr>
            <td>
                {{Form::select('event_id', $events[$acts_sk_id], '', ['class' => 'form-control select2-all'])}}
            </td>
            <td class="text-center">
                <a class="btn btn-primary" id="execute_payments">Выполнить</a>
            </td>
        </tr>
    </tbody>
</table>
    ...
    <div class="block-main">
        <div class="block-sub">
            <div class="filter-group">
                <div class="row">
                    <div class="btn-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <label class="control-label" for="act_name">№ акта</label>
                        {{ Form::select('to_act_sk_id', $acts->pluck('title', 'id'), '', ['class' => 'form-control']) }}
                    </div>
                </div>
            </div>
        </div>

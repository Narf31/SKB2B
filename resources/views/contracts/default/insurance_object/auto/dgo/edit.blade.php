                ...
                <div class="row form-horizontal">
                    ...
                    <div class="form-equally col-xs-12 col-sm-12 col-md-12 col-lg-3" >
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            ...
                            {{ Form::text("contract[object][power]", $object->power, ['class' => 'form-control sum valid_accept', "id"=>"object_ts_power"]) }}
                        </div>
...
@include('contracts.default.insurance_object.auto.dgo.js')

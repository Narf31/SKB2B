<div class="row form-horizontal" >
    ...
    <div class="row form-info col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="view-field">
            <span class="view-label">Модификация</span>
            <span class="view-value">{{$object->model_classification_code}}</span>
        </div>


        <div class="view-field">
            <span class="view-label">Противоугонное устройство</span>
            <span class="view-value">{{($object->anti_theft_system) ? $object->anti_theft_system->title : ''}}</span>
        </div>
        ...
        <div class="view-field">
            ...
            <span class="view-value">{{ $object->purpose_id > 0? \App\Models\Vehicle\VehiclePurpose::PURPOSE[$object->purpose_id] : "" }}</span>
        </div>
        ...
        <div class="view-field">
            <span class="view-label">Коробка передач</span>
            <span class="view-value">
                @if(isset(\App\Models\Contracts\ObjectInsurer\ObjectInsurerAuto::TRANSMISSION_TYPE[$object->transmission_type]))
                {{ \App\Models\Contracts\ObjectInsurer\ObjectInsurerAuto::TRANSMISSION_TYPE[$object->transmission_type] }}
                @endif
            </span>
        </div>
        ...
        <div class="view-field">
            ...
            <span class="view-value">{{ (int)$object->mileage }}</span>
        </div>

<div class="row form-horizontal">
    <div class="col-md-6 col-lg-4" >
        <div class="field form-col" @if($subject_name == 'insurer') data-intro='Поиск по конртагенту выглядит так <b>Иванов Иан Иванович 31.05.1989</b> данные подставятся автоматически' @endif>
            <div>
                ...
                {{ Form::text("contract[{$subject_name}][fio]", $subject->get_info()->fio, ['class' => 'form-control valid_accept', 'id'=>"{$subject_name}_fio", 'data-key'=>"{$subject_name}", 'placeholder' => 'Иванов Иван Иванович']) }}
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4" >
        <div class="field form-col">
            <div>
                <label class="control-label">
                    ФИО лат. @if(isset($is_lat) && $is_lat == 1)<span class="required">*</span>@endif
                </label>
                {{ Form::text("contract[{$subject_name}][fio_lat]", $subject->get_info()->fio_lat, ['class' => 'form-control '.((isset($is_lat) && $is_lat == 1)?"valid_accept":""), 'id'=>"{$subject_name}_fio_lat", 'placeholder' => 'Ivanov Ivan Ivanovich']) }}
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 col-lg-2" >
        <div class="field form-col">
            <div>
                ...
                {{Form::select("contract[{$subject_name}][sex]", collect([0=>"муж.", 1=>'жен.']), $subject->get_info()->sex, ['class' => 'form-control  select2-ws valid_accept', 'id' => "{$subject_name}_sex", 'data-key'=>"{$subject_name}"]) }}
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 col-lg-2" >
        <div class="field form-col">
            <div>
                ...
                {{ Form::text("contract[{$subject_name}][birthdate]", setDateTimeFormatRu($subject->get_info()->birthdate, 1), ['class' => 'form-control valid_accept format-date ', 'id'=>"{$subject_name}_birthdate", 'placeholder' => '18.05.1976']) }}
    ...
    <div class="col-md-6 col-lg-4 is_limit_payment_total">
        <div class="field form-col" @if($subject_name == 'insurer') data-intro='Выберите город из списка' @endif>
            <div>
                ...
                {{ Form::text("contract[{$subject_name}][address_born]", $subject->get_info()->address_born, ['class' => 'form-control limit_payment_total_valid_accept', 'id' => "{$subject_name}_address_born", 'placeholder' => '']) }}
    ...
    <div class="col-md-6 col-lg-1 is_limit_payment_total" >
        <div class="field form-col">
            <div>
                <label class="control-label">
                    Резидент
                ...
                <br/>
                <input @if($subject->is_resident == 1 || !isset($subject->is_resident)) checked="checked" @endif class="easyui-switchbutton is_resident" data-options="onText:'Да',offText:'Нет'" name="contract[{{$subject_name}}][is_resident]" id="{{$subject_name}}_is_resident" type="checkbox">

            </div>
        </div>
    </div>

    <div class="col-md-6 col-lg-3 is_limit_payment_total" >
        <div class="field form-col is_not_resident">
            <div>
                <label class="control-label">
                    Гражданство
                </label>
                {{ Form::select("contract[{$subject_name}][citizenship_id]", \App\Models\Settings\Country::orderBy('title')->get()->pluck('title', 'id'), ($subject->citizenship_id>0?$subject->citizenship_id:51), ['class' => 'form-control select2-all', 'placeholder' => '']) }}
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-6 is_limit_payment_total" >
        <div class="field form-col" @if($subject_name == 'insurer') data-intro='Выберите полный адрес из списка' @endif>
            <div>
                ...
                {{ Form::text("contract[{$subject_name}][address_register]",  $subject->get_info()->address_register, ['class' => 'form-control limit_payment_total_valid_accept', 'id' => "{$subject_name}_address_register", 'placeholder' => '']) }}
    ...
    <div class="col-md-6 col-lg-6 is_limit_payment_total" >
        <div class="field form-col">
            <div>
                ...
                {{ Form::text("contract[{$subject_name}][address_fact]", $subject->get_info()->address_fact, ['class' => 'form-control limit_payment_total_valid_accept', 'id' => "{$subject_name}_address_fact", 'placeholder' => '']) }}
    ...
    <div class="col-md-4 col-lg-4" >
        ...
        {{Form::select("contract[{$subject_name}][doc_type]", collect(\App\Models\Contracts\SubjectsFlDocType::getDocType()->pluck('title', 'isn')), $subject->get_info()->doc_type, ['class' => 'form-control select2-ws', 'style'=>'width: 100%;'])}}
    </div>
    ...
    <div class="col-md-4 col-lg-2" >
        <div class="field form-col">
            <div>
                ...
                {{ Form::text("contract[{$subject_name}][doc_serie]", $subject->get_info()->doc_serie, ['class' => 'form-control valid_accept', 'placeholder' => '1234']) }}
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4 col-lg-2" >
        <div class="field form-col">
            <div>
                ...
                {{ Form::text("contract[{$subject_name}][doc_number]", $subject->get_info()->doc_number, ['class' => 'form-control valid_accept', 'placeholder' => '567890']) }}
            </div>
        </div>
    </div>


    <div class="col-md-6 col-lg-2 is_limit_payment_total" >
        <div class="field form-col">
            <div>
                <label class="control-label">
                    Дата выдачи <span class="required">*</span>
                </label>
                {{ Form::text("contract[{$subject_name}][doc_date]", setDateTimeFormatRu($subject->get_info()->doc_date, 1), ['class' => 'form-control limit_payment_total_valid_accept format-date ', 'placeholder' => '12.05.2006']) }}
                <span class="glyphicon glyphicon-calendar calendar-icon"></span>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-2 is_limit_payment_total" >
        <div class="field form-col">
            <div>
                ...
                {{ Form::text("contract[{$subject_name}][doc_office]", $subject->get_info()->doc_office, ['class' => 'form-control limit_payment_total_valid_accept', 'placeholder' => '567890', 'id' => "{$subject_name}_doc_office"]) }}
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-12 is_limit_payment_total" >
        <div class="field form-col">
            <div>
                ...
                {{ Form::text("contract[{$subject_name}][doc_info]", $subject->get_info()->doc_info, ['class' => 'form-control limit_payment_total_valid_accept', 'placeholder' => 'РУВД Москвы', 'id' => "{$subject_name}_doc_info"]) }}
            </div>
        </div>
    </div>
...
<script>
    ...
    function initStartSubject()
    {
        ...
        @if(getFloatFormat($contract->payment_total) < 15000)

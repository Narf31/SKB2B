            ...
            <div class="form-horizontal row col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="row form-horizontal">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        ...
                        {{ Form::select("contract[insurance_amount]", \App\Models\Directories\Products\Data\DGO\Dgo::INSURANCE_AMOUNT, (int)$contract->insurance_amount, ['class' => 'form-control select2-ws clear_offers']) }}
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2" >
                        ...
                        {{ Form::select("contract[data][territory_id]", \App\Models\Directories\Products\Data\DGO\Dgo::TERRIRORY , $contract->data->territory_id, ['class' => 'form-control select2-ws clear_offers']) }}
                    </div>

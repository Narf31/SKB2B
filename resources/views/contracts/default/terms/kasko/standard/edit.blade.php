            ...
            <div class="form-horizontal row col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="row form-horizontal">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        ...
                        {{ Form::select("contract[data][is_auto_credit]", \App\Models\Contracts\ObjectInsurer\ObjectInsurerAuto::IS_CREDIT, $contract->data->is_auto_credit, ['class' => 'form-control select2-all clear_offers', 'id' => 'is_auto_credit', 'onchange' => 'controlBeneficiar()']) }}
                    </div>
...
<script>
    ...
    function controlBeneficiar() {
        if($("#is_auto_credit").val() == 1){
            $('[name*="contract[beneficiar][type]"').select2('val', 3);
            $('[name*="contract[beneficiar][type]"').change();

            $('input[name="contract[beneficiar][is_subject]"][value="0"]').trigger('click');
            $('[name*="contract[beneficiar][is_subject]"').change();
        }else{
            $('[name*="contract[beneficiar][type]"').change();
        }
    }

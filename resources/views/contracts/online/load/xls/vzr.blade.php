...
@section('title')
    ...
    <a href="/sample/vzr/load.xlsx" class="pull-right">Образец XLS</a>
...
@section('content')
    ...
    <div style="min-height: 250px">
        ...
        <div id="form-data" style="display: none;">
            ...
            {{ Form::open(['url' => url("/contracts/online/{$contract_id}/load/xls/vzr"), 'method' => 'post', 'class' => 'form-horizontal', 'id'=>'formXLS']) }}

            <input type="hidden" name="file_name">

            <div class="form-group">
                <label class="col-sm-12 control-label">Фамилия и имя латиницей</label>
                <div class="clear"></div>
                <div class="col-sm-6">
...
@section('js')
    ...
    <script>
        ...
        function setDefaultValues() {
            ...
            $('select[name="excel_columns[user_title]"]').val('fio_i_imya_latinitsey');

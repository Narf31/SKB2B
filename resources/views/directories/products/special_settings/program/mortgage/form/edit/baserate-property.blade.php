...
@section('content')
     ...
     {{ Form::open(['url' => url("/directories/products/{$product_id}/edit/special-settings/mortgage/baserate-property/{$baserate_id}"), 'method' => 'post', 'class' => 'form-horizontal']) }}
     ...
     @if($baserate_id > 0)
          ...
          <script>
              ...
              function deleteBaseRate() {
                  ...
                  $.post('{{url("/directories/products/{$product_id}/edit/special-settings/mortgage/baserate-property/{$baserate_id}")}}', {
                      _method: 'delete'
                  }, function () {

    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
        ...
        <table class="row table">
            ...
            <tr>
                <th colspan="3">
                    <h3>Скидки
                        <span class="btn btn-info pull-right" onclick="openCountryEdit(1)"><i class="fa fa-map-marker"></i></span>
            ...
            <tr>
                <th colspan="3">
                    <h3>Надбавки к тарифам
                        <span class="btn btn-info pull-right" onclick="openCountryEdit(2)"><i class="fa fa-map-marker"></i></span>
...
<div id="сountry" class="hidden">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="background-color: white;">
        <div class="form-horizontal">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
                <label class="control-label">Страна</label>
                {{Form::select("сountry_id", \App\Models\Settings\Country::orderBy('title')->get()->pluck('title', 'id'), 0, ['class' => 'form-control', "id"=>"сountry_id", 'style'=>'width: 100%;'])}}
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
                <label class="control-label">Тариф</label>
                {{Form::text("сountry_tariff", '', ['class' => 'form-control sum', 'id'=>'сountry_tariff', 'style'=>'width: 100%;'])}}
            </div>
            <input type="hidden" id="сountry_type" value="0"/>

            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
                <span class="btn btn-success pull-right" onclick="setCountry()">Сохранить</span>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function openCountryEdit(type)
    {
        //type 1 Скидки 2 Надбавки
        $("#сountry_type").val(type);
        $.fancybox.open("<div id='fancybox-data'>"+$("#сountry").html()+"</div>");
        $('.sum')
            .change(function () {
    ...
    function setCountry() {
        ...
        type = $("#fancybox-data").find("#сountry_type").val();
        country_id = $("#fancybox-data").find("#сountry_id").val();
        country_name = $("#fancybox-data").find("#сountry_id option:selected").text();
        tariff = $("#fancybox-data").find("#сountry_tariff").val();
        setValueTable(type, tariff, country_id, country_name, '', '', '');

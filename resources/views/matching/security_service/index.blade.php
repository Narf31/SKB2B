...
@section('js')
    ...
    <script>
        ...
        function loadData() {
            ...
            $.post("{{url("/matching/security-service/get-table")}}", getData(), function (response) {
        ...
        function setCheckUser(order_id) {
            ...
            var filesUrl = "/matching/security-service/"+order_id+"/set-check-user";
            $.post(filesUrl, {}, function () {
                openPage("/matching/security-service/"+order_id);
            });
        ...
        function clearCheckUser(order_id) {
            ...
            var filesUrl = "/matching/security-service/"+order_id+"/clear-check-user";
            $.post(filesUrl, {}, function () {
                loadData();

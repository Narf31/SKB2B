<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4" id="document-{{$file->id}}">
        ...
        <div class="block-image">
            @if (in_array($file->ext, ['jpg', 'jpeg', 'png', 'gif', 'JPG', 'JPEG', 'PNG']))
                ...
                <p class="file_name col-xs-12 mt-15">
                    <a href="{{ url($file->url) }}" target="_blank">{{ $file->original_name }}</a>
                </p>
            ...
            @if($view == 'edit')
                <div class="upload-close">
                    <div class="" style="float:right;color:red;">
                        <a href="javascript:void(0);" onclick="removeFileAndReloadTab('{{ $file->name }}')">

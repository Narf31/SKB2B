                    ...
                    <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 filters">
                        <div class="row ">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                ...
                                @include('orders.default.partials.cityes_select', ['city_id' => (auth()->user()->point_sale?auth()->user()->point_sale->city_id:0)])
                            </div>

                            <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                                <label class="control-label">Тип</label>
                                {{Form::select('position_type_id', collect(\App\Models\Orders\Pso::POSITION_TYPE)->prepend('Все', -1), -1, ['class' => 'form-control select2-ws', 'id'=>'position_type_id'])}}
                            </div>

                            <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                                <label class="control-label">Номер осмотра</label>
...
@section('js')
    ...
    <script>
        ...
        function selectTab(id) {
            ...
            $.post("/orders/pso/list", {status:status, data:getData()}, function (response) {
                loaderHide();
